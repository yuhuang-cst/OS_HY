...
class scheduler:
    ...
    def run(self):
        ...
        while self.get_num_active() > 0:
            ...
            #print "hy :", self.curr_proc, self.proc_info[self.curr_proc][PROC_STATE], len(self.proc_info[self.curr_proc][PROC_CODE]), instruction_to_execute
