...
int main()
{
	...
	int pte = memory[PAGE_SIZE * pt_base + pte_index];
	...
	cout << "        " << "--> Translates to Physical Address 0x" << hex << physical_addr << " --> Value: 0x" << hex << memory[physical_addr] << endl;
